 ...
 *
 */
public class ServerConnectionWatchRunnerZZZ_in_OVPN_ersetzt_ggfs_woanders_nutzen extends AbstractKernelUseObjectZZZ implements Runnable{
	...
	public ServerConnectionWatchRunnerZZZ_in_OVPN_ersetzt_ggfs_woanders_nutzen(IKernelZZZ objKernel, ServerConfigStarterOVPN objProcessStarter, String[] saFlagControl) throws ExceptionZZZ{
		super(objKernel);
